...
class RealEstatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create real_estate" do
    assert_difference("RealEstate.count") do
      post real_estates_url, params: { real_estate: { area: @real_estate.area, poster_url: @real_estate.poster_url, price: @real_estate.price, title: @real_estate.title, type: @real_estate.type } }
    end
  ...
  test "should update real_estate" do
    patch real_estate_url(@real_estate), params: { real_estate: { area: @real_estate.area, poster_url: @real_estate.poster_url, price: @real_estate.price, title: @real_estate.title, type: @real_estate.type } }
